...
/**
 * @generated from message tdf_object.v1.RunPythonScriptRequest
 */
export class RunPythonScriptRequest extends Message<RunPythonScriptRequest> {
  /**
  ...
  constructor(data?: PartialMessage<RunPythonScriptRequest>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tdf_object.v1.RunPythonScriptRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "script_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "args", kind: "scalar", T: 9 /* ScalarType.STRING */, repeated: true },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): RunPythonScriptRequest {
    return new RunPythonScriptRequest().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): RunPythonScriptRequest {
    return new RunPythonScriptRequest().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): RunPythonScriptRequest {
    return new RunPythonScriptRequest().fromJsonString(jsonString, options);
  }

  static equals(a: RunPythonScriptRequest | PlainMessage<RunPythonScriptRequest> | undefined, b: RunPythonScriptRequest | PlainMessage<RunPythonScriptRequest> | undefined): boolean {
    return proto3.util.equals(RunPythonScriptRequest, a, b);
  }
}

/**
 * @generated from message tdf_object.v1.RunPythonScriptResponse
 */
export class RunPythonScriptResponse extends Message<RunPythonScriptResponse> {
  /**
  ...
  constructor(data?: PartialMessage<RunPythonScriptResponse>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tdf_object.v1.RunPythonScriptResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "output", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "exit_code", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): RunPythonScriptResponse {
    return new RunPythonScriptResponse().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): RunPythonScriptResponse {
    return new RunPythonScriptResponse().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): RunPythonScriptResponse {
    return new RunPythonScriptResponse().fromJsonString(jsonString, options);
  }

  static equals(a: RunPythonScriptResponse | PlainMessage<RunPythonScriptResponse> | undefined, b: RunPythonScriptResponse | PlainMessage<RunPythonScriptResponse> | undefined): boolean {
    return proto3.util.equals(RunPythonScriptResponse, a, b);
  }
}
