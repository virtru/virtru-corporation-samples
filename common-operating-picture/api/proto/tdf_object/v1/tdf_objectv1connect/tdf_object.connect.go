...
const (
	...
	// TdfObjectServiceRunPythonScriptProcedure is the fully-qualified name of the TdfObjectService's
	// RunPythonScript RPC.
	TdfObjectServiceRunPythonScriptProcedure = "/tdf_object.v1.TdfObjectService/RunPythonScript"
)
...
type TdfObjectServiceClient interface {
	...
	// New RPC to trigger server-side Python logic
	RunPythonScript(context.Context, *connect.Request[v1.RunPythonScriptRequest]) (*connect.Response[v1.RunPythonScriptResponse], error)
}
...
func NewTdfObjectServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) TdfObjectServiceClient {
	...
	tdfObjectServiceMethods := v1.File_tdf_object_v1_tdf_object_proto.Services().ByName("TdfObjectService").Methods()
	return &tdfObjectServiceClient{
		createTdfObject: connect.NewClient[v1.CreateTdfObjectRequest, v1.CreateTdfObjectResponse](
			...
			connect.WithSchema(tdfObjectServiceMethods.ByName("CreateTdfObject")),
		...
		updateTdfObject: connect.NewClient[v1.UpdateTdfObjectRequest, v1.UpdateTdfObjectResponse](
			...
			connect.WithSchema(tdfObjectServiceMethods.ByName("UpdateTdfObject")),
			connect.WithClientOptions(opts...),
		),
		getTdfObject: connect.NewClient[v1.GetTdfObjectRequest, v1.GetTdfObjectResponse](
			...
			connect.WithSchema(tdfObjectServiceMethods.ByName("GetTdfObject")),
			connect.WithClientOptions(opts...),
		),
		queryTdfObjects: connect.NewClient[v1.QueryTdfObjectsRequest, v1.QueryTdfObjectsResponse](
			...
			connect.WithSchema(tdfObjectServiceMethods.ByName("QueryTdfObjects")),
			connect.WithClientOptions(opts...),
		),
		streamTdfObjects: connect.NewClient[v1.StreamTdfObjectsRequest, v1.StreamTdfObjectsResponse](
			...
			connect.WithSchema(tdfObjectServiceMethods.ByName("StreamTdfObjects")),
			connect.WithClientOptions(opts...),
		),
		getSrcType: connect.NewClient[v1.GetSrcTypeRequest, v1.GetSrcTypeResponse](
			httpClient,
			baseURL+TdfObjectServiceGetSrcTypeProcedure,
			connect.WithSchema(tdfObjectServiceMethods.ByName("GetSrcType")),
			connect.WithClientOptions(opts...),
		),
		listSrcTypes: connect.NewClient[v1.ListSrcTypesRequest, v1.ListSrcTypesResponse](
			...
			connect.WithSchema(tdfObjectServiceMethods.ByName("ListSrcTypes")),
			connect.WithClientOptions(opts...),
		),
		getEntitlements: connect.NewClient[v1.GetEntitlementsRequest, v1.GetEntitlementsResponse](
			...
			connect.WithSchema(tdfObjectServiceMethods.ByName("GetEntitlements")),
			connect.WithClientOptions(opts...),
		),
		runPythonScript: connect.NewClient[v1.RunPythonScriptRequest, v1.RunPythonScriptResponse](
			httpClient,
			baseURL+TdfObjectServiceRunPythonScriptProcedure,
			connect.WithSchema(tdfObjectServiceMethods.ByName("RunPythonScript")),
			connect.WithClientOptions(opts...),
		),
	}
}
...
type tdfObjectServiceClient struct {
	...
	runPythonScript  *connect.Client[v1.RunPythonScriptRequest, v1.RunPythonScriptResponse]
}
...
// RunPythonScript calls tdf_object.v1.TdfObjectService.RunPythonScript.
func (c *tdfObjectServiceClient) RunPythonScript(ctx context.Context, req *connect.Request[v1.RunPythonScriptRequest]) (*connect.Response[v1.RunPythonScriptResponse], error) {
	return c.runPythonScript.CallUnary(ctx, req)
}
...
func NewTdfObjectServiceHandler(svc TdfObjectServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	tdfObjectServiceRunPythonScriptHandler := connect.NewUnaryHandler(
		TdfObjectServiceRunPythonScriptProcedure,
		svc.RunPythonScript,
		connect.WithSchema(tdfObjectServiceMethods.ByName("RunPythonScript")),
		connect.WithHandlerOptions(opts...),
	)
	return "/tdf_object.v1.TdfObjectService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		case TdfObjectServiceRunPythonScriptProcedure:
			tdfObjectServiceRunPythonScriptHandler.ServeHTTP(w, r)
		default:
			http.NotFound(w, r)
		}
	})
...
func (UnimplementedTdfObjectServiceHandler) RunPythonScript(context.Context, *connect.Request[v1.RunPythonScriptRequest]) (*connect.Response[v1.RunPythonScriptResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("tdf_object.v1.TdfObjectService.RunPythonScript is not implemented"))
}
